...
$addinName = "JetBrainsAnnotations"
...
{
	Throw "Could not find FodyWeavers.xml in this project. Please enable Fody for this project http://visualstudiogallery.msdn.microsoft.com/074a2a26-d034-46f1-8fe1-0da97265eb7a"
}	
